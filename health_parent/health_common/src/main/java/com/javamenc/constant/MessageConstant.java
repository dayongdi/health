...
public class MessageConstant {
    ...
    public static final String GET_ROLE_FAIL = "获取角色数据失败";
    public static final String GET_ROLE_SUCCESS = "获取角色数据成功";
    public static final String GET_PERMISSION_SUCCESS = "获取权限数据成功";
    public static final String GET_PERMISSION_FAIL = "获取权限数据失败";
    public static final String SET_PERMISSION_SUCCESS = "设置权限数据成功";
    public static final String SET_PERMISSION_FAIL = "设置权限数据失败";
    public static final String SET_ROLE_SUCCESS = "设置角色数据成功";
    public static final String SET_ROLE_FAIL = "设置角色数据失败";
    ...
    public static final String DELETE_ADDRESS_FAIL = "该地址有用户预约, 无法删除";
    public static final String ADD_ADDRESS_SUCCESS = "新公司地址添加成功";
    public static final String ADD_ADDRESS_FAIL = "新公司地址添加失败";
    public static final String GET_ADDRESS_SUCCESS = "获取公司地址成功";
    public static final String GET_ADDRESS_FAIL = "获取公司地址失败";
    public static final String SELECTED_ADDRESS_FAIL = "选择的公司地址有误, 请重新选择";
